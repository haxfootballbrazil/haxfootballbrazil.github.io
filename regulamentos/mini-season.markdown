...
> Pular picks
>
> Não é permitido que um capitão pule sua pick. O capitão deve concluir todas as rodadas. 

## Jogos
### Jogos da temporada regular
{: .no_toc }
Os jogos da temporada regular são sorteados. O sorteio dos jogos consiste no sorteio das letras A, B, C, D e E para cada time da temporada. Cada uma das letras corresponde a uma posição na tabela de jogos. O `Jogo 1` corresponde ao jogo do primeiro horário, e `Jogo 2` corresponde ao jogo do segundo horário.
...
1. Vitórias;
2. Saldo de pontos;
3. Saldo de touchdowns;
4. Sorteio.

### Jogos da fase final
{: .no_toc }
Os quatro primeiros colocados são classificados para a fase final. O 3º e 4º colocados disputam a Wild Card, o 2º colocado e o ganhador da Wild Card disputam o Divisional Round, e o 1º colocado disputa a final contra o ganhador do Divisional Round.

<div style="border:none" markdown="1">

| Jogo                 | Time 1                    | Time 2      |
|:---------------------|:--------------------------|:------------|
| Wild Card            | 3º colocado               | 4º colocado |
| Divisional Round     | Ganhador Wild Card        | 2º colocado |
| Final de Conferência | Ganhador Divisional Round | 1º colocado |
...
17. Se houver um acordo entre todas as equipes afetadas, os horários de jogo podem ser trocados - isto é, o jogo do primeiro horário passa para o segundo, e o do segundo passa para o primeiro.
18. Se, por algum motivo extraordinário, um jogo não puder ser realizado no horário estabelecido, os capitães devem combinar um horário especial para a sua realização que não atrase o andamento da temporada.
...
| Prêmio       | Explicação                                   | Condições especiais                           | Lançamento     |
|:-------------|:---------------------------------------------|:----------------------------------------------|:---------------|
| MVP          | Jogador mais valioso                         | Não pode ganhar OPOY ou ROY                   | Antes da final |
| OPOTY        | Melhor jogador ofensivo                      | -                                             | Antes da final |
| DPOY         | Melhor jogador defensivo                     | -                                             | Antes da final |
| ROY          | Melhor novato da temporada                   | Válido somente se houver novatos na temporada | Antes da final |
| MVP da Final | Jogador mais valioso da final de conferência | Definido pela pontuação no bot                | Após a final   |
...
| Prêmio       | Explicação                              |
|:-------------|:----------------------------------------|
| Campeão      | Campeão da Final de Conferência         |
...
> Exceções
>
> Estas são medidas de emergência e devem ser evitadas.